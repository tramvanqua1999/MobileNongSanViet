...
class ProductShop extends StatefulWidget {
  ...
  @override
  _ProductSaleState createState() => _ProductSaleState(shop);
}

class _ProductSaleState extends State<ProductShop> {
  Shop shop;
  _ProductSaleState(this.shop);
  ...
  void initState() {
    super.initState();
    productFuture = downloadProductShop(shop.id);
    // setUpTimedFetch();
  }
  ...
  //     setState(() {
  //       productFuture = downloadProductShopSale(shopcode);
  //     });
  //   });
  // }
